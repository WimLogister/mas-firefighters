...
public class SimpleAgent extends Agent {
	...
	public SimpleAgent(Grid<Object> grid, double money, Vector2 direction) {
		super(grid, money, direction);
	}
	...
	public void step() {
		...
		if (fireLocation != null) {
			...
			//System.out.println(dir.xDiff + " :: " + dir.yDiff + " & " + dx + " :: " + dy);
			if (isFireInReach(dx,dy)) {
				...
				// Try other locations, if there is a fire, turn to that fire
				...
				for(int i=0; i<5;i++){
					...
					if(isFireInReachDir(dir,dx,dy)) turn(j);
						hasActed = true;
				}
			}
		}
